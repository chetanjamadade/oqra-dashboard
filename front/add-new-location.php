            ...
            <div id="accordion-form">
                        ...
                        <div class="form-horizontal col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div id="locationField">
                                    <input type="text" name="search"  placeholder="Start Typing Address" id="autocomplete"
                                           onFocus="geolocate()"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <h4>Street: <span class="requiredRed">*</span></h4>
                                <input type="text" name="street" id="route"  class ="required" />
                            </div>
                            <div class="form-group">
                                <h4>Zip Code: <span class="requiredRed">*</span></h4>
                                <input type="text" name="zip_code" id="postal_code" value="" class ="required"/>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                <h4>Name: <span class="requiredRed">*</span></h4>
                                <input type="text" name="location_name" id="name" placeholder="Adress" class="required" />
                            </div>
                            <div class="form-group">
                                <h4>City: <span class="requiredRed">*</span></h4>
                                <input type="text" name="city" id="locality" value="" class="required" />
                            </div>
                            <div class="form-group">
                                <h4>State: <span class="requiredRed">*</span></h4>
                                <input type="text" name="state" id="country" value=""  class="required" />
                            </div>
                            ...
                            <div class="panel-body" id="profileDetails">
                                <div class="row">
                                    <div class="form-horizontal col-md-6 col-xs-12">
                                        ...
                                        <textarea name="ex_satisfied_txt" class="required"></textarea>
                                    </div>
                                    <div class="form-horizontal col-md-6 col-xs-12">
                                        <h4>Very Satisfied Text: <span class="requiredRed">*</span></h4>
                                        <textarea name="very_satisfied_text" class="required"></textarea>
                                    </div>
                                    <div class="form-horizontal col-md-6 col-xs-12">
                                        <h4>Satisfied Text: <span class="requiredRed">*</span></h4>
                                        <textarea name="satisfied_text" class="required"></textarea>
                                    </div>
                                    <div class="form-horizontal col-md-6 col-xs-12">
                                        <h4>Dissatisfied Text: <span class="requiredRed">*</span></h4>
                                        <textarea name="dissatisfied_text" class="required"></textarea>
                                    </div>
                                    <div class="form-horizontal col-md-6 col-xs-12">
                                        <h4>Very Dissatisfied Text: <span class="requiredRed">*</span></h4>
                                        <textarea name="very_dissat_text" class="required"></textarea>
                                    </div>
                                    <div class="form-horizontal col-md-6 col-xs-12">
                                        <h4>Thank you Text: <span class="requiredRed">*</span></h4>
                                        <textarea name="thank_you" class="required"></textarea>
                                    </div>
                                    <div class="form-horizontal col-md-6 col-xs-12">
                                        <h4>Pre-defined text for audio review: <span class="requiredRed">*</span></h4>
                                        <textarea name="voice_text" class="required"></textarea>
                                    </div>
                                    <div class="form-horizontal col-md-6">
                                        <h4>Pre-defined text for video review: <span class="requiredRed">*</span></h4>
                                        <textarea name="video_text" class="required"></textarea>
                                    </div>
                                    <div class="col-md-12">
                ...
                <div class="form-content">
                    <div class="row">
                        <div class="form-horizontal col-md-6">
                            ...
                            <?php endif; ?>-->
                            <input type="file" name="email_image_4_5" id="email_image_4_5">
                            <p>Best dimension: 600px x 156px</p>
                        </div>
                        <div class="form-horizontal col-md-6">
                            <h4>Image in email for 3 stars and under:</h4>

                            <input type="file" name="email_image_3_under" id="email_image_3_under">
                            <p>Best dimension: 600px x 156px</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-horizontal col-md-6">
                            ...
                            <textarea name="email_4_5" class="required"></textarea>
                        </div>
                        <div class="form-horizontal col-md-6">
                            <h4>Email/messaging text for 3 stars and under ratings: <span class="requiredRed">*</span></h4>
                            <textarea name="email_3_under" class="required"></textarea>
                        </div>
                        <div class="form-horizontal col-md-6">
                    ...
                    <div class="row" style="margin-top: 10px;" >
                        <div class="form-horizontal col-md-6">
                            ...
                            <textarea class="required" name="email_address_4_5" placeholder="E-mails" /></textarea>
                        ...
                        <div class="form-horizontal col-md-6">
                            ...
                            <textarea class="required" name="email_address_3_under" placeholder="E-mails" /></textarea>
                    ...
                    <div class="row">
                        <div class="form-horizontal col-md-6">
                            ...
                            <textarea name="sms_4_5"></textarea>
                        ...
                        <div class="form-horizontal col-md-6">
                            ...
                            <textarea name="sms_3_under"></textarea>
                            <p>Enter phone number(s) comma separated with country prefix: +12101234567</p>
                        </div>
                        <div class="form-horizontal col-md-6">
                ...
                <div class="form-content">
                    <div class="row">
                        <div class="form-horizontal col-md-6">
                            ...
                            <textarea class="required" name="admin_email" placeholder="Email Text"></textarea>
                ...
                <div class="form-content">
                    ...
                    <div class="row">
                        <div class="form-horizontal col-md-6">
                            <h4>Button Text</h4>
                            <input name="ap_text" type="text" value=""/>
                        </div>
                        <div class="form-horizontal col-md-6">
                            <h4>Button URL</h4>
                            <input name="ap_url" type="text" value="" data-validation="url" data-validation-optional="true"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body" id="profileDetails">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <input type="text" class="required" name="link_fb" placeholder="Link" value="http://www.facebook.com">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <h4>Link: <span class="requiredRed">*</span></h4>
                                <input type="text" class="required" name="link_twitter" placeholder="Link" value="http://www.twitter.com">
                                <p class="desc">Note: use short urls. Click <a target="_blank" href="https://bitly.com/">here</a> to generate one</p>
                                <h4>Description: </h4>
                                <textarea name="desc_twitter" placeholder="Description">Twitter</textarea>
                                <h4>Is Active ?</h4>
                                <select name="active_twitter">
                                    <option value="1" selected="selected">Yes</option>
                                    <option value="0">No</option>
                                </select>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                ...
                                <h4>Link: <span class="requiredRed">*</span></h4>
                                <input type="text" class="required" name="link_pinterest" placeholder="Link" value="http://www.pinterest.com">
                                <p class="desc">Note: use short urls. Click <a target="_blank" href="https://bitly.com/">here</a> to generate one</p>
                                <h4>Description: </h4>
                                <textarea name="desc_pinterest" placeholder="Description">Pinterest</textarea>
                                <h4>Is Active ?</h4>
                                <select name="active_pinterest">
                                    <option value="1" selected="selected">Yes</option>
                                    <option value="0">No</option>
                                </select>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                ...
                                <h4>Link: <span class="requiredRed">*</span></h4>
                                <input type="text" class="required" name="link_yelp" placeholder="Link" value="http://www.yelp.com">
                                <p class="desc">Note: use short urls. Click <a target="_blank" href="https://bitly.com/">here</a> to generate one</p>
                                <h4>Is Active ?</h4>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <h4>Link: <span class="requiredRed">*</span></h4>
                                <input type="text" class="required" name="link_google" placeholder="Link" value="https://plus.google.com/">
                                <p class="desc">Note: use short urls. Click <a target="_blank" href="https://bitly.com/">here</a> to generate one</p>
                                <h4>Is Active ?</h4>
